...
# ==========================================
# 🚀 हाय-क्वालिटी नो-ब्लर परफेक्ट फिट लेआउट
# ==========================================
...
if uploaded_file is not None:
    if st.button("🚀 कडक ४x६ प्रिंट लेआउट तयार करा", type="primary", use_container_width=True):
        with st.spinner("⏳ क्वालिटी वाढवून काठोकाठ बॉक्स फिट केला जात आहे..."):
            try:
                ...
                if len(doc) < 1:
                    ...
                    page = doc[0]
                    # क्वालिटी कडक करण्यासाठी DPI थेट ४०० केला (अक्षरे अजिबात ब्लर होणार नाहीत)
                    ...
                    # 🎯 कार्ड न कट होता संपूर्ण बॉर्डर मिळवण्यासाठी कडक सेफ क्रॉपिंग
                    ...
                    # 📏 ४x६ पेपरचा आकार कार्डच्या अचूक रुंदीशी मॅच केला (१०५० x १६०० पिक्सेल्स)
                    # यामुळे कार्ड अजिबात चपटं किंवा लहान दिसणार नाही आणि रिकामी पांढरी जागा उडेल
                    PAPER_WIDTH, PAPER_HEIGHT = 1050, 1600
                    card_w, card_h = 1050, 690
                    ...
                    # 🎯 डाव्या-उजव्या बाजूला थेट ० पिक्सेलवर लॉक करून पेस्ट (Zero Margin)
                    final_canvas.paste(img_front, (0, 60))
                    final_canvas.paste(img_back, (0, 850))
                    ...
                    draw.rectangle([0, 850, PAPER_WIDTH - 1, 850 + card_h], outline="black", width=5)
                    ...
                    st.image(final_canvas, caption="४x६ कडक प्रिंट प्रिव्ह्यू (हाय-क्वालिटी)", width=600)
                    st.write("")
                    ...
                    st.download_button(
                        ...
                        file_name=f"Ayushman_HD_PerfectFit_{unique_time}.png",
                        mime="image/png",
