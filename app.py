...
# ==========================================
# 🚀 परफेक्ट फिटिंग - नो एक्स्ट्रा मार्जिन लेआउट
# ==========================================
...
if uploaded_file is not None:
    if st.button("🚀 कडक ४x६ प्रिंट लेआउट तयार करा", type="primary", use_container_width=True):
        with st.spinner("⏳ कडांना तंतोतंत मॅच करणारा बॉक्स तयार होत आहे..."):
            try:
                ...
                if len(doc) < 1:
                    ...
                    # 📏 ४x६ पेपरच्या कडांना तंतोतंत चिकटवण्यासाठी आणि चपटं न दिसण्यासाठी परफेक्ट आकडे
                    PAPER_WIDTH, PAPER_HEIGHT = 1200, 1800
                    card_w, card_h = 1130, 715  # कार्डची अचूक प्रमाणबद्ध साईझ
                    ...
                    # 🎯 कार्ड्स मध्यभागी पेस्ट करणे
                    paste_x = (PAPER_WIDTH - card_w) // 2
                    
                    final_canvas.paste(img_front, (paste_x, 100))
                    final_canvas.paste(img_back, (paste_x, 950))
                    
                    # 🔲 🎯 कडक बदल: बाहेरचा मोठा फालतू बॉक्स काढून थेट कार्डच्या कडांना चिकटून ४ पिक्सेलची बॉर्डर मारणे!
                    from PIL import ImageDraw
                    draw = ImageDraw.Draw(final_canvas)
                    
                    # यामुळे काळी रेघ थेट कार्डच्या रेषेवर बसेल, क्रॉप करताना १ टक्काही पांढरा भाग उरणार नाही
                    draw.rectangle([paste_x, 100, paste_x + card_w, 100 + card_h], outline="black", width=4)
                    ...
                    # स्क्रीनवर सुरक्षित प्रिव्ह्यू
                    st.image(final_canvas, caption="४x६ कडक प्रिंट प्रिव्ह्यू (परफेक्ट फिट बॉक्स)", width=650)
                    st.write("")
                    ...
                    st.download_button(
                        ...
                        file_name=f"Ayushman_BoxFit_{unique_time}.png",
                        mime="image/png",
