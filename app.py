...
# ==========================================
# 🚀 डेक्सटॉप ऍपप्रमाणे १००% कडक काठोकाठ लेआउट
# ==========================================
...
if uploaded_file is not None:
    if st.button("🚀 कडक ४x६ प्रिंट लेआउट तयार करा", type="primary", use_container_width=True):
        with st.spinner("⏳ डेक्सटॉप मास्टर लॉजिकनुसार काठोकाठ कटिंग सुरू आहे..."):
            try:
                ...
                if len(doc) < 1:
                    ...
                    # 🎯 डेक्सटॉप ओरिजिनल कोऑर्डिनेट्सनुसार कडक क्रॉपिंग (No White Margins)
                    ...
                    # 📏 ४x६ पेपरची पूर्ण रुंदी व्यापणारी परफेक्ट साईझ (१२०० पिक्सेल)
                    ...
                    # कॅश मेमरी क्लिअर करण्यासाठी युनिक आयडी फाईल नेम
