...
if uploaded_file is not None:
    if st.button("🚀 कडक ४x६ प्रिंट लेआउट तयार करा", type="primary", use_container_width=True):
        with st.spinner("⏳ कालच्या परफेक्ट लॉजिकनुसार लेआउट तयार होत आहे..."):
            try:
                ...
                if len(doc) < 1:
                    ...
                    # 🎯 कालचे शंभर टक्के अचूक ओरीजनल क्रॉपिंग कोऑर्डिनेट्स
                    ...
                    # 🎯 डाव्या आणि उजव्या कडेला ० मार्जिन (Edge-to-Edge परफेक्ट पेस्ट)
                    final_canvas.paste(img_front, (0, 80))
                    final_canvas.paste(img_back, (0, 950))
                    
                    # 🔲 कात्रीने व्यवस्थित कापण्यासाठी कालची कडक काळी बॉर्डर
                    ...
                    st.success(f"✅ आयुष्मान भारत कार्ड आता कालच्या सारखे परफेक्ट रिस्टोर झाले आहे! (User: {st.session_state.user_role})")
                    
                    # स्क्रीन प्रिव्ह्यू
                    st.image(final_canvas, caption="४x६ प्रिंट प्रिव्ह्यू (कालचा परफेक्ट कोड)", width=650)
                    st.write("")
                    ...
                    st.download_button(
                        ...
                        file_name=f"Ayushman_Original_Fit_{unique_time}.png",
                        mime="image/png",
