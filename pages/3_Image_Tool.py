...
# ==========================================
# 🛠️ २. चार मुख्य टूल्स (१००% ऑटोमॅटिक)
# ==========================================
tab1, tab2, tab3, tab4 = st.tabs([
    "🖨️ ओरिजिनल आधार कार्ड कटर (Full Auto 4x6)", 
...
# ------------------------------------------
# 🖨️ टॅब १: १००% ऑटोमॅटिक पॉकेट आधार कार्ड कटर (No Manual Sliders)
# ------------------------------------------
with tab1:
    st.markdown("<h4 style='color: #0056b3;'>🖨️ ओरिजिनल आधार कार्ड कटर (१-क्लिक १००% ऑटो-फिट)</h4>", unsafe_allow_html=True)
    st.info("⚡ मॅन्युअल काहीही सरकवायची गरज नाही! PDF टाकून पासवर्ड द्या आणि थेट १-क्लिकमध्ये ४x६ प्रिंट काढा.")
    ...
    if pdf_file is not None:
        if st.button("🚀 ओरिजिनल आधार ४x६ ऑटो-लेआउट तयार करा", type="primary", use_container_width=True, key="btn_aadhaar_gen"):
            with st.spinner("⏳ स्वयंचलित तंत्रज्ञानाने नको असलेला भाग कट करून आधार कार्ड सेट होत आहे..."):
                try:
                    ...
                    # 🎯 १००% परफेक्ट ऑटो पॉकेट क्रॉप कॉर्डिनेट्स (एक्स्ट्रा मजकूर आपोआप गायब)
                    crop_front = full_img.crop((int(w * 0.055), int(h * 0.708), int(w * 0.490), int(h * 0.955)))
                    crop_back = full_img.crop((int(w * 0.510), int(h * 0.708), int(w * 0.945), int(h * 0.955)))
                    
                    PAPER_W, PAPER_HEIGHT = 1200, 1800
                    final_canvas = Image.new("RGB", (PAPER_W, PAPER_HEIGHT), "white")

                    # ओरिजिनल पॉकेट कार्ड अचूक प्रमाण (1050 x 630 px)
                    card_w, card_h = 1050, 630
                    ...
                    # ४x६ वर सेंटर पेस्टिंग
                    final_canvas.paste(front_bordered, (paste_x, 180))
                    final_canvas.paste(back_bordered, (paste_x, 950))

                    st.success("✅ १-क्लिक ऑटोमॅटिक पॉकेट कटिंग पूर्ण झाले आहे!")
                    st.image(final_canvas, caption="Balaji_Aadhaar_Auto_4x6.png", use_container_width=True)
                    ...
                    st.download_button(
                        ...
                        file_name="Balaji_Aadhaar_4x6_Auto.png", 
                        mime="image/png", 
